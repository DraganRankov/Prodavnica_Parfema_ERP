...
const steps = ['Podaci za slanje', 'Pregledajte porudžbinu', 'Detalji plaćanja'];
    ...
    async function submitOrder(data: FieldValues) {
        ...
        try {
            ...
            if (paymentResult.paymentIntent?.status === 'succeeded') {
                ...
                setPaymentMessage('Hvala Vam- prihvatili smo vašu uplatu');
                        ...
                        <>
                            ...
                            {paymentSucceeded ? (
                                <Typography variant="subtitle1">
                                    Vaš broj porudžbine je  #{orderNumber}. Zahvalni smo što kupujete kod nas!
                                </Typography>
                            ) : (
